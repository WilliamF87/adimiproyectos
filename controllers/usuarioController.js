...
const registrar = async (req, res) => {
    // Notificar al usuario de correo ya re registrado
    const { email } = req.body;
    const existeUsuario = await Usuario.findOne({ email });
    // findOne va a buscar el primer registro que coincida con esa entrada (email)
    // Como se llaman igual (email: email), se puede dejar sólo email
    ...
    try {
        // En req.body está la información importante del request
